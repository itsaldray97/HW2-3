...
def verify(m, public_key, signed_message):
    ...
    signer = eth_account.Account.recover_message(message, signature=signature)
    valid_signature = True if signer.lower() == public_key.lower() else False #lowercase to ensure case insensitivity
